  ...
  const contactInfo = [
    {
      icon: '📧',
      title: 'Email',
      value: 'dpolasisai@gmail.com',
      link: 'mailto:dpolasisai@gmail.com',
    },
    {
      icon: '📱',
      title: 'Phone',
      value: '+1 7869691054',
      link: 'tel:+17869691054',
    },
    {
      icon: '📍',
      title: 'Location',
          ...
          <div className="contact-social-section">
            <Card className="contact-social-card">
              ...
              <p className="contact-social-description">
                Reach out through my social media profiles
              </p>
              <div className="social-circles">
                <a
                  href="https://www.linkedin.com/in/deepaksaipolasi/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/its_deeeee_/"
                  target="_blank"
                  rel="noopener noreferrer"
